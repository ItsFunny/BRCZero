...
type InscriptionContext struct {
	...
	InscriptionNumber uint64   `json:"inscription_number" yaml:"inscription_number"` //铭文编号
	...
	CommitInput       []TxOut  `json:"commit_input" yaml:"commit_input"`             //提交交易的输入
...
type SatPoint struct {
	...
	Offset   uint64   `json:"offset" yaml:"offset"`     // 聪数
}
