...
import (
	...
	srvconfig "github.com/brc20-collab/brczero/libs/cosmos-sdk/server/config"
...
func TestnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for an brczero testnet",
...
func InitTestnet(
	...
	if chainID == "" {
		chainID = fmt.Sprintf("brczero-%d", tmrand.Int63n(9999999999999)+1)
	}
