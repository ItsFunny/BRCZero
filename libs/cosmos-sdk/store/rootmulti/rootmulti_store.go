...
import (
	...
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/cachemulti"
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/dbadapter"
	...
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/mem"
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/mpt"
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/tracekv"
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/transient"
	"github.com/brc20-collab/brczero/libs/cosmos-sdk/store/types"
	sdk "github.com/brc20-collab/brczero/libs/cosmos-sdk/types"
	sdkerrors "github.com/brc20-collab/brczero/libs/cosmos-sdk/types/errors"
	iavltree "github.com/brc20-collab/brczero/libs/iavl"
	"github.com/brc20-collab/brczero/libs/iavl/config"
	"github.com/brc20-collab/brczero/libs/system/trace"
	"github.com/brc20-collab/brczero/libs/system/trace/persist"
...
func (rs *Store) loadVersion(ver int64, upgrades *types.StoreUpgrades) error {
	...
	if !IgPruneHeightsLen && len(rs.pruneHeights) > maxPruneHeightsLength {
		return fmt.Errorf("Pruned heights length <%d> exceeds <%d>, "+
			...
			"<brczerod data prune-compact state --home your_brczerod_home_directory> before running brczerod",
