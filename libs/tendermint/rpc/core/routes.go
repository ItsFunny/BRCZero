...
import (
	rpc "github.com/brc20-collab/brczero/libs/tendermint/rpc/jsonrpc/server"
)
...
var Routes = map[string]*rpc.RPCFunc{
	...
	"broadcast_brczero_txs_async": rpc.NewRPCFunc(BroadcastBrczeroTxsAsync, "height,block_hash,txs"),
