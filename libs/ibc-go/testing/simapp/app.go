...
import (
	...
	govclient "github.com/brc20-collab/brczero/libs/cosmos-sdk/x/mint/client"
	...
	"github.com/brc20-collab/brczero/libs/ibc-go/testing/mock"
	"github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/capability"
	"github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/core"
	evm2 "github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/evm"
	"github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/fee"
	ica2 "github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/ica"
	staking2 "github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/staking"
	"github.com/brc20-collab/brczero/libs/ibc-go/testing/simapp/adapter/transfer"
...
func (app *SimApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	// if appconfig.GetBRCZeroConfig().GetEnableDynamicGp() {
	// 	GlobalGpIndex = CalBlockGasPriceIndex(app.blockGasPrice, appconfig.GetBRCZeroConfig().GetDynamicGpWeight())
